...
public class BookControllerAsJsonTest {
	private final Logger logger = LoggerFactory.getLogger(BookControllerAsJsonTest.class);
	...
	public void testUpdateBook() throws Exception {
		Book updateBook = new Book(3L, "어스시의 마법사", "어슬러 K, 르귄", "판타지소설", new Date());
		// Java 2 Json
		...
		this.mockMvc.perform(requestBuilder).andDo(print())
			...
			.andExpect(jsonPath("$.creator", is("어슬러 K, 르귄")));
	}
